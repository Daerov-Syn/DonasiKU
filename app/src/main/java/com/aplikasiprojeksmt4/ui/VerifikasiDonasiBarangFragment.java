...
public class VerifikasiDonasiBarangFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.filterSemua.setOnClickListener(v -> {
            setActiveFilter(v);
            binding.cardDonasi1.setVisibility(View.VISIBLE);
            binding.cardDonasi2.setVisibility(View.VISIBLE);
            binding.cardDonasi3.setVisibility(View.VISIBLE);
            binding.cardDonasi4.setVisibility(View.VISIBLE);
            binding.cardDonasi5.setVisibility(View.VISIBLE);
        });

        binding.filterTerjadwal.setOnClickListener(v -> {
            setActiveFilter(v);
            binding.cardDonasi1.setVisibility(View.VISIBLE);
            binding.cardDonasi2.setVisibility(View.VISIBLE);
            binding.cardDonasi3.setVisibility(View.VISIBLE);
            binding.cardDonasi4.setVisibility(View.GONE); // Sembunyikan Tersalurkan
            binding.cardDonasi5.setVisibility(View.GONE);
        });

        binding.filterTersalurkan.setOnClickListener(v -> {
            setActiveFilter(v);
            binding.cardDonasi1.setVisibility(View.GONE); // Sembunyikan Terjadwal
            binding.cardDonasi2.setVisibility(View.GONE);
            binding.cardDonasi3.setVisibility(View.GONE);
            binding.cardDonasi4.setVisibility(View.VISIBLE);
            binding.cardDonasi5.setVisibility(View.VISIBLE);
        });
    }
